const footer = '<div class="text-end d-inline-flex align-items-center p-4">\n' +
    '            <span class="tb">© 2023 Все права защищены.</span>\n' +
    '            <a class="link tb ms-3 d-inline-flex align-items-center" href="https://github.com/Voyadger-Odin/JetBrainsDesign" target="_blank">\n' +
